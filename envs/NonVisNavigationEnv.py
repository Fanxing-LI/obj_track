...
class NonVisNavigationEnv(DroneGymEnvsBase):
    def __init__(
        self,
        ...
        "state_generator":
            {
                "class": "Uniform",
                "kwargs": [
                    {"position": {"mean": [15.0, -10.0, 1], "half": [0,0,0]}},
                ]
            }
    }
    target = [15.0, 10.0, 1]
    scene_path = "VisFly/datasets/visfly-beta/configs/scenes/box15_wall_square_tri_circle_pillars_cov30_sx70_sz70_r07_c07_sp306_var10_rotp0150"
    sensor_kwargs = [{
