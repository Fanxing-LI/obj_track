...
from envs.HardNavigationEnv import HardNavigationEnv
...
def parse_args():
    parser = argparse.ArgumentParser(description='Run hard navigation experiments', add_help=False)
    ...
    parser.add_argument("--env", "-e", type=str, default="hard_navigation",)
...
# Environment aliases
env_alias = {
    "hard_navigation": HardNavigationEnv,
}
