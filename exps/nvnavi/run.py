...
from envs.NonVisNavigationEnv import NonVisNavigationEnv
...
def parse_args():
    parser = argparse.ArgumentParser(description='Run non-visual navigation experiments', add_help=False)
    ...
    parser.add_argument("--env", "-e", type=str, default="nonvis_navigation",)
...
# Environment aliases
env_alias = {
    "nonvis_navigation": NonVisNavigationEnv,
}
...
if __name__ == "__main__":
    ...
    if args.train:
        ...
        #         "position": [[14.0, 0.0, 6.0], [0.0, -2.0, 0.0]],  # Angled position for good coverage
        #         "line_width": 8.,
        #         "trajectory": True,
        #         "axes": True,
        #     }
            ...
            try:
                ...
                if figs is not None and not isinstance(figs, list):
                    if isinstance(figs, matplotlib.figure.Figure):
                        ...
                        figs = list(figs)
                # Generate debug analysis plots per-episode
                try:
