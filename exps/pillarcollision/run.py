...
from envs.PillarCollisionEnv import PillarCollisionEnv
...
def parse_args():
    ...
    parser.add_argument('--comment', '-c', type=str, default="pillar_collision")
    parser.add_argument("--train", "-t", type=int, default=1)
    parser.add_argument("--algorithm", "-a", type=str, default="BPTT",
                        choices=["BPTT", "SHAC"],
                        help="Algorithm to use for training")
    parser.add_argument("--env", "-e", type=str, default="pillar_collision",)
...
# Environment aliases
env_alias = {
    "pillar_collision": PillarCollisionEnv,
}
