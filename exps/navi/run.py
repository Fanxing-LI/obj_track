...
def parse_args():
    parser = argparse.ArgumentParser(description='Run navigation experiments', add_help=False)
    parser.add_argument('--comment', '-c', type=str, default="navigation")
...
if __name__ == "__main__":
    ...
    if args.train:
        ...
        # eval_config = env_config["eval_env"].copy()
        # eval_config["scene_kwargs"] = test_scene_kwargs
        # eval_config["num_agent_per_scene"] = 1  # Override for single agent testing
