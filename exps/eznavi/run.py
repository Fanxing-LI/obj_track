...
from envs.EasyNavigationEnv import EasyNavigationEnv
...
def parse_args():
    parser = argparse.ArgumentParser(description='Run eazy navigation experiments', add_help=False)
    ...
    parser.add_argument("--env", "-e", type=str, default="eazy_navigation",)
...
# Environment aliases
env_alias = {
    "eazy_navigation": EasyNavigationEnv,
}
