...
from envs.PColPFEnv import PColPFEnv
...
if __name__ == "__main__":
    ...
    if args.train:
        ...
        n_eval_episodes = 16  # how many complete episodes to evaluate for SR alignment
